 ...
 */
package org.lunarray.model.generation.jsf.render.factories.form;
 ...
 *            The entity type.
 */
public interface FormPropertyRenderStrategy<P, E> {
	...
	interface Factory {
		 ...
		 *            The entity.
		 */
		<P, E> FormPropertyRenderStrategy<P, E> createStrategy(RenderContext context);
	}
}
