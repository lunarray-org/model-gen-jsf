 ...
 *            The entity type.
 */
public final class DefaultSingleMenuInput<P, E>
	 ...
	 */
	protected DefaultSingleMenuInput(final RenderContext jsfContext) {
		super(jsfContext);
	}
	...
	protected UIInput createInput(final PropertyDescriptor<P, E> property, final RenderContext context) {
		...
		input.setStyleClass(context.resolveStyleClass(JsfStyleClasses.FORM_INPUT_SMENU));
		return input;
	}
	...
	public static final class FactoryImpl
		...
		public <P, E> FormPropertyRenderStrategy<P, E> createStrategy(final RenderContext context) {
			...
			return new DefaultSingleMenuInput<P, E>(context);
		}
	}
}
