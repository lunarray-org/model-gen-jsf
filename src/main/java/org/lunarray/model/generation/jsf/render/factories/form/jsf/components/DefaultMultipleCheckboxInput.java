 ...
 *            The entity type.
 */
public final class DefaultMultipleCheckboxInput<P, E>
	 ...
	 */
	protected DefaultMultipleCheckboxInput(final RenderContext jsfContext) {
		super(jsfContext);
	}
	...
	protected UIInput createInput(final PropertyDescriptor<P, E> property, final RenderContext context) {
		...
		input.setStyleClass(context.resolveStyleClass(JsfStyleClasses.FORM_INPUT_MCHECKBOX));
		return input;
	}
	...
	public static final class FactoryImpl
		...
		public <P, E> FormPropertyRenderStrategy<P, E> createStrategy(final RenderContext context) {
			...
			return new DefaultMultipleCheckboxInput<P, E>(context);
		}
	}
}
