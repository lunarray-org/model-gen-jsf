 ...
 *            The entity type.
 */
public final class DefaultTextOutput<P, E>
	 ...
	 */
	protected DefaultTextOutput(final ValueExpression modelExpression) {
	...
	public static final class FactoryImpl
		...
		public <P, E> TablePropertyDescriptorRenderStrategy<P, E> createStrategy(final RenderContext context) {
			...
			return new DefaultTextOutput<P, E>(context.getModelExpression());
		}
	}
}
