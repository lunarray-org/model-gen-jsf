 ...
 *            The entity type.
 */
public final class DefaultTextInput<P, E>
		extends AbstractPropertyRenderStrategy<P, E> {

	/**
	 * Default constructor.
	 */
	protected DefaultTextInput() {
		super();
	}
	...
	protected UIInput createInput(final PropertyDescriptor<P, E> property, final RenderContext context) {
		final HtmlInputText input = new HtmlInputText();
		input.setStyleClass(context.resolveStyleClass(JsfStyleClasses.FORM_INPUT_TEXT));
		return input;
	}
	...
	public static final class FactoryImpl
		...
		public <P, E> FormPropertyRenderStrategy<P, E> createStrategy(final RenderContext context) {
			return new DefaultTextInput<P, E>();
		}
	}
}
