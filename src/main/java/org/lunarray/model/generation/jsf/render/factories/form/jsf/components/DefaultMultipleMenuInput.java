 ...
 *            The entity type.
 */
public final class DefaultMultipleMenuInput<P, E>
	 ...
	 */
	protected DefaultMultipleMenuInput(final RenderContext jsfContext) {
		super(jsfContext);
	}
	...
	protected UIInput createInput(final PropertyDescriptor<P, E> property, final RenderContext context) {
		final HtmlSelectOneMenu input = new HtmlSelectOneMenu();
		input.setStyleClass(context.resolveStyleClass(JsfStyleClasses.FORM_INPUT_MMENU));
		return input;
	}
	...
	public static final class FactoryImpl
		...
		public <P, E> FormPropertyRenderStrategy<P, E> createStrategy(final RenderContext context) {
			...
			return new DefaultMultipleMenuInput<P, E>(context);
		}
	}
}
