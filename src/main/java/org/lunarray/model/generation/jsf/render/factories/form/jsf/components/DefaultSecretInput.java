 ...
 *            The entity type.
 */
public final class DefaultSecretInput<P, E>
		extends AbstractPropertyRenderStrategy<P, E> {

	/**
	 * Default constructor.
	 */
	protected DefaultSecretInput() {
		super();
	}
	...
	protected UIInput createInput(final PropertyDescriptor<P, E> property, final RenderContext context) {
		final HtmlInputSecret input = new HtmlInputSecret();
		input.setStyleClass(context.resolveStyleClass(JsfStyleClasses.FORM_INPUT_SECRET));
		return input;
	}
	...
	public static final class FactoryImpl
		...
		public <P, E> FormPropertyRenderStrategy<P, E> createStrategy(final RenderContext context) {
			return new DefaultSecretInput<P, E>();
		}
	}
}
