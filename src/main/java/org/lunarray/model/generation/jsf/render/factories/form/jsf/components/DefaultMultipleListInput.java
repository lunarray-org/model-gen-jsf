 ...
 *            The entity type.
 */
public final class DefaultMultipleListInput<P, E>
	 ...
	 */
	protected DefaultMultipleListInput(final RenderContext jsfContext) {
		super(jsfContext);
	}
	...
	protected UIInput createInput(final PropertyDescriptor<P, E> property, final RenderContext context) {
		final HtmlSelectManyListbox input = new HtmlSelectManyListbox();
		input.setStyleClass(context.resolveStyleClass(JsfStyleClasses.FORM_INPUT_MLISTBOX));
		return input;
	}
	...
	public static final class FactoryImpl
		...
		public <P, E> FormPropertyRenderStrategy<P, E> createStrategy(final RenderContext context) {
			...
			return new DefaultMultipleListInput<P, E>(context);
		}
	}
}
