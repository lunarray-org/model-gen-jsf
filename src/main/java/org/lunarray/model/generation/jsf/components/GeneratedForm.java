 ...
 *            The entity type.
 */
public interface GeneratedForm<S, E extends S> {

	/**
	 * Processes a property.
	 * 
	 * @param strategy
	 *            The property strategy. May not be null.
	 * @param renderContext
	 *            The render context. May not be null.
	 */
	void processProperty(FormPropertyRenderStrategy<?, ?> strategy, RenderContext renderContext);
}
