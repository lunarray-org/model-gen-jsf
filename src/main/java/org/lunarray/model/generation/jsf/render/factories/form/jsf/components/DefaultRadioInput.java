 ...
 *            The entity type.
 */
public final class DefaultRadioInput<P, E>
	 ...
	 */
	protected DefaultRadioInput(final RenderContext jsfContext) {
		super(jsfContext);
	}
	...
	protected UIInput createInput(final PropertyDescriptor<P, E> property, final RenderContext context) {
		final HtmlSelectOneRadio input = new HtmlSelectOneRadio();
		input.setStyleClass(context.resolveStyleClass(JsfStyleClasses.FORM_INPUT_RADIO));
		return input;
	}
	...
	public static final class FactoryImpl
		...
		public <P, E> FormPropertyRenderStrategy<P, E> createStrategy(final RenderContext context) {
			...
			return new DefaultRadioInput<P, E>(context);
		}
	}
}
